...
class Bill_App:
    def __init__(self, root):
        ...
        bg_color = "blue"
        title = Label(self.root, text="Billing Software", font=('roboto sans', 30, 'bold'), pady=2, bd=12, bg="cyan", fg="black", relief=RAISED)
        title.pack(fill=X)
    # ================variables=======================
    ...
    # =============customer retail details======================
        F1 = LabelFrame(self.root, text="Customer Details", font=('roboto sans', 15, 'bold'), bd=10, fg="black", bg="cyan")
        F1.place(x=0, y=80, relwidth=1)
        cname_lbl = Label(F1, text="Customer Name:", bg=bg_color, font=('roboto sans', 15, 'bold'))
        cname_lbl.grid(row=0, column=0, padx=20, pady=5)
        cname_txt = Entry(F1, width=15, textvariable=self.c_name, font='arial 15', bd=7, relief=SUNKEN)
        cname_txt.grid(row=0, column=1, pady=5, padx=10)

        cphn_lbl = Label(F1, text="Customer Phone:", bg="blue", font=('roboto sans', 15, 'bold'))
        ...
        c_bill_lbl = Label(F1, text="Bill Number:", bg="blue", font=('roboto sans', 15, 'bold'))
    ...
    # ===================Medical====================================
        F2 = LabelFrame(self.root, text="Stationary Items", font=('roboto sans', 15, 'bold'), bd=10, fg="Black", bg="blue")
        F2.place(x=5, y=180, width=325, height=380)

        sanitizer_lbl = Label(F2, text="Pen", font=('roboto sans', 16, 'bold'), bg="cyan", fg="black")
        sanitizer_lbl.grid(row=0, column=0, padx=10, pady=10, sticky='W')
        sanitizer_txt = Entry(F2, width=10, textvariable=self.sanitizer, font=('roboto sans', 16, 'bold'), bd=5, relief=GROOVE)
        sanitizer_txt.grid(row=0, column=1, padx=10, pady=10)

        mask_lbl = Label(F2, text="Notebooks", font=('roboto sans', 16, 'bold'), bg="cyan", fg="black")
        ...
        hand_gloves_lbl = Label(F2, text="Pouches", font=('roboto sans', 16, 'bold'), bg="cyan", fg="black")
        ...
        dettol_lbl = Label(F2, text="Toys Bundle", font=('roboto sans', 16, 'bold'), bg="cyan", fg="black")
        ...
        newsprin_lbl = Label(F2, text="Sticky Notes", font =('roboto sans', 16, 'bold'), bg = "cyan", fg = "black")
        ...
        thermal_gun_lbl = Label(F2, text="Files", font=('roboto sans', 16, 'bold'), bg="cyan", fg="black")
    ...
    # ==========GroceryItems=========================
        F3 = LabelFrame(self.root, text="Mens wear", font=('roboto sans', 15, 'bold'), bd=10, fg="Black", bg="blue")
        F3.place(x=340, y=180, width=325, height=380)

        rice_lbl = Label(F3, text="Shirts", font=('roboto sans', 16, 'bold'), bg="cyan", fg="black")
        ...
        food_oil_lbl = Label(F3, text="Casuals", font=('roboto sans', 16, 'bold'), bg="cyan", fg="black")
        ...
        wheat_lbl = Label(F3, text="Sports Wears", font=('roboto sans', 16, 'bold'), bg="cyan", fg="black")
        ...
        daal_lbl = Label(F3, text="Blazers", font=('roboto sans', 16, 'bold'), bg="cyan", fg="black")
        ...
        flour_lbl = Label(F3, text="Lounge wears", font=('roboto sans', 16, 'bold'), bg="cyan", fg="black")
        ...
        maggi_lbl = Label(F3, text="Jeans", font=('roboto sans', 16, 'bold'), bg="cyan", fg="black")
    ...
    # ===========ColdDrinks================================
        F4 = LabelFrame(self.root, text="Accessories", font=('roboto sans', 15, 'bold'), bd=10, fg="Black", bg="blue")
        F4.place(x=670, y=180, width=325, height=380)

        sprite_lbl = Label(F4, text="Glasses", font=('roboto sans', 16, 'bold'), bg="cyan", fg="black")
        sprite_lbl.grid(row=0, column=0, padx=10, pady=10, sticky='W')
        sprite_txt = Entry(F4, width=10, textvariable=self.sprite, font=('roboto sans', 16, 'bold'), bd=5, relief=GROOVE)
        sprite_txt.grid(row=0, column=1, padx=10, pady=10)

        limka_lbl = Label(F4, text="Belt", font=('roboto sans', 16, 'bold'), bg="cyan", fg="black")
        ...
        mazza_lbl = Label(F4, text="Shoes", font=('roboto sans', 16, 'bold'), bg="cyan", fg="black")
        ...
        coke_lbl = Label(F4, text="Watch", font=('roboto sans', 16, 'bold'), bg="cyan", fg="black")
        ...
        fanta_lbl = Label(F4, text="Bracelet", font=('roboto sans', 16, 'bold'), bg="cyan", fg="black")
        fanta_lbl.grid(row=4, column=0, padx=10, pady=10, sticky='W')
        fanta_txt = Entry(F4, width=10, textvariable=self.fanta, font=('roboto sans', 16, 'bold'), bd=5, relief=GROOVE)
        fanta_txt.grid(row=4, column=1, padx=10, pady=10)

        mountain_duo_lbl = Label(F4, text="Hat", font=('roboto sans', 16, 'bold'), bg="cyan", fg="black")
        mountain_duo_lbl.grid(row=5, column=0, padx=10, pady=10, sticky='W')
        mountain_duo_txt = Entry(F4, width=10, textvariable=self.mountain_duo, font=('roboto sans', 16, 'bold'), bd=5, relief=GROOVE)
    ...
    # =======================ButtonFrame=============
        F6 = LabelFrame(self.root, text="Bill Area", font=('roboto sans', 14, 'bold'), bd=10, fg="Black", bg="cyan")
        F6.place(x=0, y=560, relwidth=1, height=140)

        m1_lbl = Label(F6, text="Total Stationary items", font=('roboto sans', 14, 'bold'), bg="blue", fg="black")
        ...
        m2_lbl = Label(F6, text="Total Mens wear", font=('roboto sans', 14, 'bold'), bg="blue", fg="black")
        ...
        m3_lbl = Label(F6, text="Total Accessories", font=('roboto sans', 14, 'bold'), bg="blue", fg="black")
        ...
        m4_lbl = Label(F6, text="Stationary items Tax", font=('roboto sans', 14, 'bold'), bg="blue", fg="black")
        ...
        m5_lbl = Label(F6, text="Mens wear Tax", font=('roboto sans', 14, 'bold'), bg="blue", fg="black")
        ...
        m6_lbl = Label(F6, text="Accessories Tax", font=('roboto sans', 14, 'bold'), bg="blue", fg="black")
...
#=========billArea=================================================
    ...
    # ============medical================================
        if self.sanitizer.get() != 0:
            self.txtarea.insert(END, f"\n pen\t\t{self.sanitizer.get()}\t\t{self.m_s_p}")
        if self.mask.get() != 0:
            self.txtarea.insert(END, f"\n Note books\t\t{self.mask.get()}\t\t{self.m_m_p}")
        if self.hand_gloves.get() != 0:
            self.txtarea.insert(END, f"\n Pouches\t\t{self.hand_gloves.get()}\t\t{self.m_h_g_p}")
        if self.dettol.get() != 0:
            self.txtarea.insert(END, f"\n Toys bundle\t\t{self.dettol.get()}\t\t{self.m_d_p}")
        if self.newsprin.get() != 0:
            self.txtarea.insert(END, f"\n sticky notes\t\t{self.newsprin.get()}\t\t{self.m_n_p}")
        if self.thermal_gun.get() != 0:
            self.txtarea.insert(END , f"\n files\t\t{self.sanitizer.get()}\t\t{self.m_t_g_p}")
    # ==============Grocery============================
        if self.rice.get() != 0:
            self.txtarea.insert(END, f"\n Shirts\t\t{self.rice.get()}\t\t{self.g_r_p}")
        if self.food_oil.get() != 0:
            self.txtarea.insert(END, f"\n Casuals\t\t{self.food_oil.get()}\t\t{self.g_f_o_p}")
        if self.wheat.get() != 0:
            self.txtarea.insert(END, f"\n Sports Wears\t\t{self.wheat.get()}\t\t{self.g_w_p}")
        if self.daal.get() != 0:
            self.txtarea.insert(END, f"\n Blazers\t\t{self.daal.get()}\t\t{self.g_d_p}")
        if self.flour.get() != 0:
            self.txtarea.insert(END, f"\n Lounge Wears\t\t{self.flour.get()}\t\t{self.g_f_p}")
        if self.maggi.get() != 0:
            self.txtarea.insert(END, f"\n Jeeans\t\t{self.maggi.get()}\t\t{self.g_m_p}")
        #================ColdDrinks==========================
        if self.sprite.get() != 0:
            self.txtarea.insert(END, f"\n Glasses\t\t{self.sprite.get()}\t\t{self.c_d_s_p}")
        if self.limka.get() != 0:
            self.txtarea.insert(END, f"\n Belt\t\t{self.limka.get()}\t\t{self.c_d_l_p}")
        if self.mazza.get() != 0:
            self.txtarea.insert(END, f"\n Shoes\t\t{self.mazza.get()}\t\t{self.c_d_m_p}")
        if self.coke.get() != 0:
            self.txtarea.insert(END, f"\n watch\t\t{self.coke.get()}\t\t{self.c_d_c_p}")
        if self.fanta.get() != 0:
            self.txtarea.insert(END, f"\n Bracelet\t\t{self.newsprin.get()}\t\t{self.c_d_f_p}")
        if self.mountain_duo.get() != 0:
            self.txtarea.insert(END, f"\n Hat\t\t{self.sanitizer.get()}\t\t{self.c_m_d}")
            self.txtarea.insert(END, f"\n--------------------------------")
        # ===============taxes==============================
        if self.medical_tax.get() != '0.0':
            self.txtarea.insert(END, f"\n Stationary Tax\t\t\t{self.medical_tax.get()}")
        if self.grocery_tax.get() != '0.0':
            self.txtarea.insert(END, f"\n Mens wear Tax\t\t\t{self.grocery_tax.get()}")
        if self.cold_drinks_tax.get() != '0.0':
            self.txtarea.insert(END, f"\n Accessories Tax\t\t\t{self.cold_drinks_tax.get()}")
